...
//
// - `type`: The type can be "arg", "option" or "command:. If omitted, the default is
// "arg". If any other type is provided, the field is ignored.
//
// - `name`: The name of the argument, option or command. If omitted, the default is the
...
//
// - `help`: The help text for the argument, option or command, will be displayed in the
